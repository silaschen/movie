...
class Index extends Common
{
    public function index(){
		...
		$movie = Db::name('video')->select();
		$this->assign('slidetwo',$movie);
		$this->assign('webserver',"http://hotelnsb.top/");
   		return $this->fetch('index',['title'=>'aa']);
    }
	...
	*/
	public function selectshow(){
		...
		$sql = "select b.time,b.cinemaid,b.btime,b.etime,c.name,c.address from  tickets b  JOIN cinemas c ON b.cinemaid=c.id where b.videoid='$id'";
		$res = Db::query($sql);
		foreach($res as $k=>$v){
		...
		$this->assign('webserver',"http://13.113.88.95/index.php/");
